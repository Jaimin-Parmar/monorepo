...
type CachedAccountRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CachedAccountRequest) Reset() {
	*x = CachedAccountRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CachedAccountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CachedAccountRequest) ProtoMessage() {}

func (x *CachedAccountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_account_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CachedAccountRequest.ProtoReflect.Descriptor instead.
func (*CachedAccountRequest) Descriptor() ([]byte, []int) {
	return file_proto_account_proto_rawDescGZIP(), []int{4}
}

func (x *CachedAccountRequest) GetAccountId() int32 {
	if x != nil {
		return x.AccountId
	}
	return 0
...
var file_proto_account_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x35, 0x0a, 0x14, 0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xa1, 0x01, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x71,
	...
	0x10, 0x47, 0x65, 0x74, 0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x1d, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x43, 0x61, 0x63, 0x68,
	0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x15, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x69, 0x63, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x62, 0x06, 0x70,
...
var file_proto_account_proto_goTypes = []interface{}{
	...
	(*CachedAccountRequest)(nil), // 4: account.CachedAccountRequest
...
var file_proto_account_proto_depIdxs = []int32{
	...
	6, // 1: account.AccountReply.create_date:type_name -> google.protobuf.Timestamp
	6, // 2: account.AccountReply.last_modified_date:type_name -> google.protobuf.Timestamp
	2, // 3: account.AccountReply.accounts:type_name -> account.AccountPermission
	6, // 4: account.AccountReply.reset_time:type_name -> google.protobuf.Timestamp
	7, // 5: account.GenericReply.data:type_name -> google.protobuf.Any
	0, // 6: account.AccountService.AuthAccount:input_type -> account.CredentialsRequest
	4, // 7: account.AccountService.GetCachedAccount:input_type -> account.CachedAccountRequest
	3, // 8: account.AccountService.AuthAccount:output_type -> account.AccountReply
	5, // 9: account.AccountService.GetCachedAccount:output_type -> account.GenericReply
...
func file_proto_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_account_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CachedAccountRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
